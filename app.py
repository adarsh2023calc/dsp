...
def extract_data(url):
    ...
    for _ in range(count):
        ...
        crypto_list.append({
            ...
            "Market Cap": random.randint(1e6, 1e12),
            "Trading Volume (24h)": random.randint(1e3, 1e9),
            ...
            "Total Supply": random.randint(1e5, 1e9),
            "Circulating Supply": random.randint(1e5, 1e8),
            "Max Supply": random.randint(1e5, 1e10),
